function redirectToActualizarProducto(idProducto) {
    window.location.href = "actualizarProducto.html?id=" + idProducto;
  }
...
window.addEventListener('DOMContentLoaded', async () => {
    ...
    querySnapshot.forEach(doc => {
        ...
        html += `
            <tr>
                ...
                <th><a id="${task.IdProducto}" class="boton-personalizado" href="actualizarProducto.html?id=${task.IdProducto}" onclick="redireccionar(this)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
    ...
    function redireccionar(elemento) {
        const idProducto = elemento.parentElement.parentElement.cells[0].textContent;
        window.location.href = `actualizarProducto.html?id=${idProducto}`;
      }
})
